      ...
      <>
        ...
        <main className="max-w-7xl mx-auto px-4 py-8">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6">
            ...
            <Link href="/sales-orders" className="mt-3 inline-block text-red-700 hover:text-red-800">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="text-purple-800">
              ...
              {salesOrder.origin_quote ? (
                <Link href={`/quotes/${salesOrder.origin_quote.id}`} className="font-medium underline">
                  {salesOrder.origin_quote.quote_number}
                </Link>
              ) : (
                <Link href={`/quotes/${salesOrder.origin_quote_id}`} className="font-medium underline">
                  View Origin Quote
                </Link>
              )}
            </p>
        ...
        <div className="mb-6">
          <div className="flex items-center gap-4 mb-2">
            <Link href="/sales-orders" className="text-gray-500 hover:text-gray-700">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
              </svg>
            </Link>
            <h1 className="text-2xl font-bold text-gray-900">{salesOrder.sales_order_number}</h1>
