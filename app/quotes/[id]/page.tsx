...
// AttachmentTag enum available for future use
      ...
      <>
        ...
        <main className="max-w-7xl mx-auto px-4 py-8">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6">
            ...
            <Link href="/quotes" className="mt-3 inline-block text-red-700 hover:text-red-800">
              Back to Quotes
            </Link>
          </div>
        </main>
          ...
          {quote.quote_status === 'converted' && quote.sales_order && (
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-4">
              <p className="text-purple-800">
                ...
                <Link href={`/sales-orders/${quote.sales_order.id}`} className="font-medium underline">
                  {quote.sales_order.sales_order_number}
                </Link>
              </p>
            </div>
          )}
          ...
          <div className="mt-4 flex gap-3 items-center">
            ...
            {quote.quote_status === 'converted' ? (
              <span className="px-4 py-2 text-sm font-medium text-purple-700 bg-purple-100 rounded-md">
                Already converted to SO #{quote.sales_order?.sales_order_number || '...'}
              </span>
