...
const logger = createLogger().child({ module: 'api.scope-lines' });
...
export async function GET(_request: NextRequest, { params }: RouteParams) {
  try {
    ...
    if (error) {
      logger.error('api.scope-lines.fetch.failed', { errorCode: ErrorCodes.DB_QUERY_FAILED, error });
    ...
    logger.error('api.scope-lines.get.failed', { errorCode: ErrorCodes.API_INTERNAL_ERROR, error });
...
export async function POST(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    if (error) {
      logger.error('api.scope-lines.create.failed', { errorCode: ErrorCodes.DB_INSERT_FAILED, error });
      return NextResponse.json(
    ...
    logger.error('api.scope-lines.post.failed', { errorCode: ErrorCodes.API_INTERNAL_ERROR, error });
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    if (error) {
      logger.error('api.scope-lines.update.failed', { errorCode: ErrorCodes.DB_UPDATE_FAILED, error });
      return NextResponse.json(
    ...
    logger.error('api.scope-lines.patch.failed', { errorCode: ErrorCodes.API_INTERNAL_ERROR, error });
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
...
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    if (error) {
      logger.error('api.scope-lines.delete.failed', { errorCode: ErrorCodes.DB_DELETE_FAILED, error });
      return NextResponse.json(
    ...
    logger.error('api.scope-lines.delete-handler.failed', { errorCode: ErrorCodes.API_INTERNAL_ERROR, error });
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
